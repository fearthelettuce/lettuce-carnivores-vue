...
export const guideData = {
    ...
    genus:{
        heliamphora: {
            label: "Heliamphora",
            locale: "Heliamphora are native to highland plateaus called Tepuis in South America. Tepuis receive a ridiculous amount of rainfall which washes away most nutrients in the soil, thus Heliamphora have adapted to get their nutrition from... other sources 😉.",
            humidity: "Heliamphora need supplemental humidity to thrive. I keep mine between 75-90% RH.",
            water: "Since Heliamphora naturally get a tremendous amount of rain, I generally give them more water than my Nepenthes and I make sure to fill the pitchers with each watering.",
            ...
            media: "I use the same mix as nepenthes, a loose draining mix of long-fibered sphagnum moss and perlite. I also use coco husk chips, although it's important to find a brand that has low salt content.",
