<template>
    <div class="container">
        ...
        <h2>Contact</h2>
        <p>For questions, please contact us at <span><a href="mailto:service@dangerlettuce.com">service@dangerlettuce.com</a></span> or send us a message on <a href="https://www.instagram.com/dangerlettuce/" target="_blank">Instagram</a></p>
        <div class="m-2">
        ...
        <div>
            ...
            <p>Plants are guaranteed to arrive alive and in reasonable condition.  In this case, reasonable condition means that 75% of the plant is undamaged, and that damage does not threaten the health of the plant. For example, if the growth point of a nepenthes is broken off, that plant has a high likelihood of dying and that would qualify for a refund. A heliamphora that arrives with some damaged pitchers would not qualify for a refund, unless the main growth point of the plant was damaged. </p>
            <p>To qualify for a refund under the Live Arrival Guarantee, contact service@dangerlettuce.com or DangerLettuce on Instagram/Facebook within 24 hours of the delivery time.  Include photos of the package and plant showing the damage.</p>
            ...
            <p>I will make an attempt to accommodate all cancellation requests up until the time the printing label is created. Many orders are shipped same-day, so please contact us immediately (Instagram is best) if you need to make a change. </p>
