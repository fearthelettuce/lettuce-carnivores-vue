<template>
    <header v-if="!route.meta.hideHeader" class="mb-2 sticky-top">
        <nav    >
            <div>
            ...
            <div class="flex flex-wrap items-center justify-between mx-auto p-4">
                <router-link to="/" class="logo-link">
                    <span class="logo self-center text-2xl font-semibold whitespace-nowrap dark:text-white" >Danger Lettuce</span>
                </router-link>
                <div class="flex md:order-2">
                    ...
                    <div class="relative hidden md:block">
                        ...
                        <input type="text" id="search-navbar" class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-lime-500 focus:border-lime-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-lime-500 dark:focus:border-lime-500" placeholder="Search...">
                    </div>
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                    <ul class="flex flex-col align-center p-4 mx-2 mb-0 md:p-0 font-medium md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0">
                        <li v-for="item of allowedNavLinks" :key="item.name">
                        <router-link
                            :to="item.path"
